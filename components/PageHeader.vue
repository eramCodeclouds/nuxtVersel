...
.white-header .site-header .logo-holder a img:last-child,
.site-header.sticky .logo-holder a img:last-child {
  display: block;
}
.white-header .site-header .logo-holder a img:first-child,
...
.white-header .site-header .navbar-nav .nav-item a.nav-link,
.sticky .navbar-nav .nav-item a.nav-link {
  color: #162535;
}
.white-header .site-header .navbar-nav .nav-item a.nav-link:hover,
...
.white-header .site-header .nav-item.mr-megamenu > a.nav-link:after,
.sticky .nav-item.mr-megamenu > a.nav-link:after {
  filter: invert(0);
}
.white-header .site-header .nav-item.mr-megamenu > a:hover.nav-link:after,
...
@media (max-width: 1023px) {
  ...
  .white-header .site-header .mobile-menu-trigger span,
